  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单状态" align="center" prop="orderStatus">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.course_order_status" :value="scope.row.orderStatus"/>
        </template>
      </el-table-column>
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder } from "@/api/psy/order"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('psy/order/export', {
        ...this.queryParams
