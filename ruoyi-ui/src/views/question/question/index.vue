<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="提问用户" prop="userId">
        <el-input
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userId: [
          { required: true, message: "提问用户不能为空", trigger: "blur" }
        ],
      }
    }
  },
