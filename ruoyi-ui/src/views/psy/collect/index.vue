...
<script>
import { listCollect, getCollect, delCollect, addCollect, updateCollect } from "@/api/psy/collect"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('psy/collect/export', {
        ...this.queryParams
