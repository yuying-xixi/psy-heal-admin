<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="回复咨询师ID" prop="consultId">
        <el-input
          v-model="queryParams.consultId"
          placeholder="请输入回复咨询师ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="是否为最佳答案" prop="isBest">
        <el-input
          v-model="queryParams.isBest"
          placeholder="请输入是否为最佳答案"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['assessment:reply:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['assessment:reply:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['assessment:reply:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['assessment:reply:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="replyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="回复咨询师ID" align="center" prop="consultId" />
      <el-table-column label="所属问题ID" align="center" prop="questionId" />
      <el-table-column label="是否为最佳答案" align="center" prop="isBest" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="是否为最佳答案" prop="isBest">
              <el-input v-model="form.isBest" placeholder="请输入是否为最佳答案" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import { listReply, getReply, delReply, addReply, updateReply } from "@/api/assessment/reply"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        consultId: [
          { required: true, message: "回复咨询师ID不能为空", trigger: "blur" }
        ],
        questionId: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('assessment/reply/export', {
        ...this.queryParams
