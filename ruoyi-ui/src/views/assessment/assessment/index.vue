<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="assessmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="测评简介" align="center" prop="assessmentIntro" />
      ...
      <el-table-column label="用户收获" align="center" prop="whatYouGet" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="测评简介" prop="assessmentIntro">
              <el-input v-model="form.assessmentIntro" type="textarea" placeholder="请输入内容" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="关于测评" prop="aboutAssessment">
              <el-input v-model="form.aboutAssessment" type="textarea" placeholder="请输入内容" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="适合谁测" prop="suitableFor">
              <el-input v-model="form.suitableFor" type="textarea" placeholder="请输入内容" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
import { listAssessment, getAssessment, delAssessment, addAssessment, updateAssessment } from "@/api/assessment/assessment"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('assessment/assessment/export', {
        ...this.queryParams
