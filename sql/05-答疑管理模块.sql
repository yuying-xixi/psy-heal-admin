...
CREATE TABLE `question_reply` (
                                  ...
                                  CONSTRAINT `fk_reply_question` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`)
...
CREATE TABLE `question_like` (
                                 ...
                                 CONSTRAINT `fk_like_question` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`)
