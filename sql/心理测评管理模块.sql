...
CREATE TABLE `assessment` (
                              ...
                              CONSTRAINT `fk_assessment_category` FOREIGN KEY (`category_id`) REFERENCES `assessment_category` (`id`)
...
CREATE TABLE `assessment_question` (
                                       ...
                                       CONSTRAINT `fk_question_assessment` FOREIGN KEY (`assessment_id`) REFERENCES `assessment` (`id`)
...
CREATE TABLE `assessment_result` (
                                     ...
                                     CONSTRAINT `fk_result_assessment` FOREIGN KEY (`assessment_id`) REFERENCES `assessment` (`id`)
...
CREATE TABLE `assessment_answer_detail` (
                                            ...
                                            KEY `idx_question` (`question_id`),
                                            CONSTRAINT `fk_detail_result` FOREIGN KEY (`result_id`) REFERENCES `assessment_result` (`id`)
